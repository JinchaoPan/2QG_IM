%% Draw a Error variation graph with respect to the iteration time(Figure 6)
% if the error value is infinite, replace it with e^{450}.

% The Figure 6 in the manuscript will be presented,
% when T=12 in file "MyQG_Mesh_Time".
QQ1=ERROR_absQ1;
QQ2=ERROR_absQ2;
pp1=ERROR_absp1;
pp2=ERROR_absp2;
...
legend('ln(ErQ1(n))','ln(ErQ2(n))','ln(ErP1(n))','ln(ErP2(n))','FontSize',10, 'Location', 'northwest')
