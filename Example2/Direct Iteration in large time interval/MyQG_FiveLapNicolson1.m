...
%     q1NUM=NaN*ones((n-1)*(m-1),k+1);
%     q2NUM=NaN*ones((n-1)*(m-1),k+1);
end
...
psi_num1h(2:end-1,2:end-1)=psi_num1i;
psi_num2h(2:end-1,2:end-1)=psi_num2i;
...
psi_num1(2:end-1,2:end-1)=psi_num1i;
psi_num2(2:end-1,2:end-1)=psi_num2i;
