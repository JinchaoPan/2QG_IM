...
q1_num1h=[SYQ_1k(:,1,tk_ms) [SXQ_1k(1,2:end-1,tk_ms);q1_num1i;SXQ_1k(end,2:end-1,tk_ms)] SYQ_1k(:,end,tk_ms)];
q2_num1h=[SYQ_2k(:,1,tk_ms) [SXQ_2k(1,2:end-1,tk_ms);q2_num1i;SXQ_2k(end,2:end-1,tk_ms)] SYQ_2k(:,end,tk_ms)];
