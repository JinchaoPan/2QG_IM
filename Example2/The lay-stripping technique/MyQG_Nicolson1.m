...
%% t=T/2
cbq1=[-0.342410681240217,1.136583547355490];
cbq2=[-0.190120409745703,0.660723753472983];
if odev==1 && Li==Lih
    tk_ms=k/2+1;
    ta1=tk(tk_ms);
...
%     view(0,90)
    ...
    q1_k1h=q1_k1;  q1_num1h=q1_num1; abs_error1h=abs_error1;
    q2_k1h=q2_k1;  q2_num1h=q2_num1; abs_error2h=abs_error2;
    ta1h=ta1;
end
