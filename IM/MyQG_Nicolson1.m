...
f1_0=f1_0+F1*DDpsi1d2k(:,kk)/Re*sign(A);
f1_0=reshape(f1_0,[m-1,n-1]);
BQQ1=BQQL1+tau*f1_0;
...
f2_0=f2_0-Sigma*DDpsi2k(:,kk)-F2*DDpsi1d2k(:,kk)/Re*sign(A)-DD_RS/Re*sign(A);
...
AErrL2_Q1=(abs_error1(:)'*abs_error1(:))/(q1_k1(:)'*q1_k1(:));
AErrL2_Q2=(abs_error2(:)'*abs_error2(:))/(q2_k1(:)'*q2_k1(:));
AErrL2_Q1=sqrt(AErrL2_Q1);
AErrL2_Q2=sqrt(AErrL2_Q2);
